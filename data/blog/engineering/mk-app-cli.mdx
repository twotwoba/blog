...
tags: ['cli', 'react']
draft: false
summary: '一个简单的脚手架, 使用 vite + react + typescript + tailwindcss + zustand + prettier + eslint.'
images: []
layout: PostLayout
---
...
- 配置 `tailwindcss`, 修改 `.vscode/settings.json/tailwindCSS.experimental.classRegex`, 使得在变量中也能给出 `tailwindcss` 提示
