...
后面在 B 站看了左神的算法课，他说了这么一句话：<span className='text-[#55bde2]'>国外根本就不存在什么回溯的概念，就是暴力递归</span>。
...
{/* 通常使用栈来保存当前节点及后续要访问的节点, 回溯本身就在做 dfs 的遍历，因此也能使用栈，更重要的是它通过参数传递状态和记录搜索路径 */}
...
<div className="flex gap-2">
    <img src="https://cdn.jsdelivr.net/gh/yokiizx/picgo@main/img/202403242041410.png" className="w-1/2" />
    <img src="https://cdn.jsdelivr.net/gh/yokiizx/picgo@main/img/202403242041080.png" className="w-1/2" />
</div>
