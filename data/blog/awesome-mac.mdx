...
### Update: 鼠须管(雾凇拼音+小鹤双拼) & 删除自带ABC

https://github.com/rime/squirrel

前端时间在 v2ex 看到有人推荐鼠须管和双拼，试用了一下，发现还不错，尤其是雾凇拼音，词库还算丰富，且支持icloud同步，隐私性强。其他特性比如高度可自定义、支持多种皮肤等，感兴趣的可以自行研究。
...
_便捷管理、切换多个 hosts 方案的工具_

```sh
# 比如：配置 github 的访问(实测还是没有🪜来的实在～)
Host 类型： Remote
